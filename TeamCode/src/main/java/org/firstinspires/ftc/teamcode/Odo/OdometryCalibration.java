...
public class OdometryCalibration extends LinearOpMode {
    ...
    //Odometry Wheels
    DcMotor verticalLeft, horizontal;
    ...
    String verticalLeftEncoderName = rbName, horizontalEncoderName = rfName;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initHardwareMap(rfName, rbName, lfName, lbName, verticalLeftEncoderName, horizontalEncoderName);
       ...
       */
        double encoderDifference = Math.abs(verticalLeft.getCurrentPosition());
    ...
    private void initHardwareMap(String rfName, String rbName, String lfName, String lbName, String vlEncoderName, String hEncoderName){
